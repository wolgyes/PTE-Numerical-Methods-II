...
fprintf('NOTE: The secant method plots show how the method approximates\n');
fprintf('      the curve with straight lines. With highly curved functions\n');
fprintf('      (like x^3 or e^(-x)), the iterative secant lines are very\n');
fprintf('      visible and clearly different from the actual curve.\n\n');
